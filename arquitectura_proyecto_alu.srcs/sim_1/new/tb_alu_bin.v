...
=======
  ...
  endtask
>>>>>>> e12065aa45e529e0cb0d8e5f59deb6030f8c6df4

  initial begin
    op = 2'b11; // c√≥digo de operaci√≥n: divisi√≥n
    ...
    #10;
    if (y == expected)
      $display("‚úÖ Test 1 OK: 4.0 / 2.0 => %b (esperado %b)", y, expected);
    else
      $display("‚ùå Test 1 FAIL: 4.0 / 2.0 => %b (esperado %b)", y, expected);
...
<<<<<<< HEAD
    ...
    #10;
    if (y == expected)
      $display("‚úÖ Test 2 OK: 5.0 / 2.0 => %b (esperado %b)", y, expected);
    else
      $display("‚ùå Test 2 FAIL: 5.0 / 2.0 => %b (esperado %b)", y, expected);
    ...
    #10;
    if (y == expected)
      $display("‚úÖ Test 3 OK: 3.0 / 3.0 => %b (esperado %b)", y, expected);
    else
      $display("‚ùå Test 3 FAIL: 3.0 / 3.0 => %b (esperado %b)", y, expected);
=======
...
run(2'b10,
    ...
    // ============================================
// CASOS DE MULTIPLICACI”N CON REDONDEO
// ============================================
...
run(2'b10,
    16'b0011110000000001, // 1.0 + ulp (aproximaciÛn)
    16'b0011111000000000, // 1.5
...
run(2'b10,
    ...
    16'b0011110101001000, // Necesita verificaciÛn manual
...
// CASO 18: Producto muy pequeÒo - todos bits bajos
run(2'b10,
    16'b0011110000000001, // 1.0 + ulp
    16'b0011110000000001, // 1.0 + ulp
...
// CASO 22: MÌnima mantisa ◊ mÌnima mantisa
run(2'b10,
    16'b0011110000000001, // 1.0 + ulp
    16'b0011110000000001, // 1.0 + ulp
...
// CASO 23: PatrÛn alternante de bits
run(2'b10,
...
>>>>>>> e12065aa45e529e0cb0d8e5f59deb6030f8c6df4
    ...
    #10;
    if (y == expected)
      $display("‚úÖ Test 4 OK: 1.0 / 2.0 => %b (esperado %b)", y, expected);
    else
      $display("‚ùå Test 4 FAIL: 1.0 / 2.0 => %b (esperado %b)", y, expected);
...
<<<<<<< HEAD
    ...
    #10;
    if (y == expected)
      $display("‚úÖ Test 5 OK: 5.0 / 5.0 => %b (esperado %b)", y, expected);
    else
      $display("‚ùå Test 5 FAIL: 5.0 / 5.0 => %b (esperado %b)", y, expected);
=======
    //    (-2.0) + 1.0 = -1.0  (si quieres probar signo; EXPECT no verificado aquÌ)
